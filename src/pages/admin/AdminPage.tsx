...
type Tab = "users" | "loginLogs" | "activityLogs" | "goods" | "orders";
  ...
  return (
    <div className="min-h-screen p-6 md:p-10 text-white">
      ...
      {activeTab === "orders" && (
        <>
          <div className="flex justify-between items-center mb-4">
            <p className="text-gray-400 text-sm">총 {orders.length}건</p>
            <button onClick={loadOrders} className="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-sm font-semibold transition-colors">새로고침</button>
          </div>
          {orders.length === 0 ? (
            ...
            <div className="flex flex-col gap-4">
              {orders.map((o) => {
                ...
                const isEditingTracking = trackingEdit?.orderId === o.orderId;
